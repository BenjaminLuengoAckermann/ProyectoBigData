...
def ejecutar(delitos):
    ...
    acum, index_max, max = calculos.calcular_cantidad_delitos_por_barrio(lista=lista_franja_horarios,
    ...
    print("\n La franja horaria con mas delitos es {} con {} delitos".format(franja_horaria[index_max].upper(),
                                                            max))
